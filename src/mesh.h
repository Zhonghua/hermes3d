...
public:
	...
	virtual int get_num_of_vertices() const = 0;
	virtual int get_num_of_edges() const = 0;
	virtual int get_num_of_faces() const = 0;
	...
	virtual int get_face_num_of_vertices(int face_num) const = 0;
	virtual int get_face_num_of_edges(int face_num) const = 0;
...
public:
	...
	virtual int get_num_of_vertices() const { return NUM_VERTICES; }
	virtual int get_num_of_edges() const { return NUM_EDGES; }
	virtual int get_num_of_faces() const { return NUM_FACES; }
	...
	virtual int get_face_num_of_vertices(int face_num) const { return Quad::NUM_VERTICES; }
	virtual int get_face_num_of_edges(int face_num) const { return Quad::NUM_EDGES; }
	...
	virtual int get_num_of_sons() { return NUM_SONS; }
...
public:
	...
	virtual int get_face_num_of_vertices(int face_num) const  { return Tri::NUM_VERTICES; }
	virtual int get_face_num_of_edges(int face_num) const { return Tri::NUM_EDGES; }
	// FIXME
	virtual int get_face_vertices(int face_num, Word_t *vtcs) const;
	virtual const int *get_face_vertices(int face_num) const;
...
public:
	...
	virtual int get_face_num_of_vertices(int face_num) const;
	virtual int get_face_num_of_edges(int face_num) const;
	// FIXME
	virtual int get_face_vertices(int face_num, Word_t *vtcs) const;
	virtual const int *get_face_vertices(int face_num) const;
